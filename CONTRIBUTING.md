...
Follow the steps underline in the [README.md](https://github.com/TudorOrban/ChainOptim-Microservices/blob/main/README.md).
...
We are committed to providing a welcoming and inclusive experience for everyone. We expect all participants to adhere to our Code of Conduct. Please read [Code of Conduct](https://github.com/TudorOrban/ChainOptim-Microservices/blob/main/CODE_OF_CONDUCT.md) to understand what behaviors will not be tolerated.
