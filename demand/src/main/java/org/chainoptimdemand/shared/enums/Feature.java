...
public enum Feature {
    ...
    public String toString() {
        return switch (this) {
            ...
            case SUPPLIER_ORDER -> "Client Order";
            case SUPPLIER_SHIPMENT -> "Client Shipment";
            case SUPPLIER_PERFORMANCE -> "Client Performance";
            case CLIENT -> "Client";
    ...
    public Feature fromString(String feature) {
        return switch (feature) {
            ...
            case "Client Performance" -> SUPPLIER_PERFORMANCE;
            case "Client" -> CLIENT;
