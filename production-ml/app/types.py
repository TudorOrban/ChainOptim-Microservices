...
class ResourceAllocation(BaseModel):
    ...
    allocated_amount: float = Field(..., alias=to_camel('allocated_amount'))
    requested_amount: float = Field(..., alias=to_camel('requested_amount'))
    actual_amount: float = Field(..., alias=to_camel('actual_amount'))
...
class AllocationResult(BaseModel):
    ...
    component_id: int = Field(..., alias=to_camel('component_id'))
    component_name: str = Field(..., alias=to_camel('component_name'))
    resulted_amount: float = Field(..., alias=to_camel('resulted_amount'))
    full_amount: float = Field(..., alias=to_camel('full_amount'))
    actual_amount: float = Field(..., alias=to_camel('actual_amount'))
...
class DailyProductionRecord(BaseModel):
    ...
    duration_days: float = Field(..., alias=to_camel('duration_days'))
